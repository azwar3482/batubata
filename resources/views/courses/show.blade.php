    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <nav class="flex items-center gap-2 text-sm text-gray-500 dark:text-slate-400 mb-4">
                ...
                <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
                <span class="text-gray-900 dark:text-white font-medium">Detail Kursus</span>
            </nav>
                ...
                <div class="flex items-start justify-between">
                    <div class="flex-1">
                        <div class="flex items-center gap-3 mb-3">
                            ...
                            @if($course->is_free)
                            <span class="px-3 py-1 bg-green-500/30 rounded-full text-xs font-bold">Gratis</span>
                            @endif
                        </div>
                    ...
                    <div class="text-right">
                        @if($course->is_free)
                        <span class="text-3xl font-bold text-green-300">Gratis</span>
                        @else
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-xl shadow-md border border-gray-100 dark:border-slate-700 p-6">
                        <h2 class="text-lg font-bold text-gray-900 dark:text-white mb-3">Deskripsi Kursus</h2>
                    ...
                    @if($progress)
                    <div class="bg-white dark:bg-slate-800 rounded-xl shadow-md border border-gray-100 dark:border-slate-700 p-6">
                        <h2 class="text-lg font-bold text-gray-900 dark:text-white mb-4">Progress Belajar</h2>
                        <div class="mb-4">
                            <div class="flex justify-between text-sm text-gray-600 dark:text-slate-400 mb-2">
                                <span>{{ $progress->status === 'completed' ? 'Selesai' : ($progress->status === 'in_progress' ? 'Sedang Belajar' : 'Belum Dimulai') }}</span>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-xl shadow-md border border-gray-100 dark:border-slate-700 p-6">
                        ...
                        <div class="space-y-3 text-sm">
                            ...
                            <div class="flex justify-between py-2 border-b border-gray-100 dark:border-slate-700">
                                <span class="text-gray-500 dark:text-slate-400">Chapter</span>
                                <span class="font-medium text-gray-900 dark:text-white">{{ $course->chapters->count() }}</span>
                            </div>
                            <div class="flex justify-between py-2">
                                <span class="text-gray-500 dark:text-slate-400">Materi</span>
                        ...
                        <div class="mt-6 space-y-3">
                            ...
                            <a href="{{ route('seeker.courses.learn', $course->id) }}"
                                ...
                                {{ $progress->status === 'completed' ? 'Pelajari Lagi' : 'Lanjutkan Belajar' }}
                            </a>
                            @else
