...
<body class="bg-slate-100 min-h-screen flex flex-col justify-between py-6">
    ...
    <div class="no-print max-w-5xl mx-auto w-full px-6 flex justify-between items-center mb-4">
        ...
        <div class="flex gap-2">
            ...
            <a href="{{ route('courses.platform-certificate.pdf', $progress->id) }}" class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-bold shadow transition flex items-center gap-1.5 text-xs">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
