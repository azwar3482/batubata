...
<head>
    ...
    <style>
        ...
        .dark .menu-link.text-slate-600 { color: #cbd5e1; }
        .dark .menu-link:hover { background-color: rgba(30, 41, 59, 0.8) !important; color: #f1f5f9 !important; }
        .dark .menu-link.bg-gradient-to-r { background: linear-gradient(to right, rgba(30, 58, 138, 0.2), rgba(49, 46, 129, 0.1)) !important; color: #60a5fa !important; border-color: #3b82f6 !important; }
        .dark .sidebar-icon.text-slate-400 { color: #64748b; }
        .dark .menu-tooltip { background: #0f172a; border: 1px solid #334155; }
        .dark .user-card { background: linear-gradient(to bottom right, #1e293b, rgba(49, 46, 129, 0.2)); border-color: rgba(51, 65, 85, 0.8); }
        .dark .user-info-text p.text-slate-800 { color: #e2e8f0; }
        .dark .user-info-text span.bg-blue-50 { background-color: rgba(30, 58, 138, 0.3); color: #93c5fd; border-color: rgba(30, 58, 138, 0.5); }
        ...
        .dark .hover\:bg-slate-50\/80:hover { background-color: rgba(51, 65, 85, 0.5) !important; }
        ...
        .dark .bg-white {
            background-color: #1e293b !important; /* Elevated slate-800 card color */
        }
        .dark .bg-gray-50, 
        .dark .bg-slate-50,
        .dark .bg-slate-100 {
            background-color: #0f172a !important; /* Deep slate-900 background */
        }
        .dark .bg-gray-100 {
        ...
        .dark .text-gray-700,
        .dark .text-slate-700 {
            color: #f8fafc !important; /* Slate-50 off-white for main titles, values & labels */
        }
        ...
        .dark .text-gray-400,
        .dark .text-slate-400 {
            color: #cbd5e1 !important; /* Slate-300 bright gray for description texts and subtitles */
        }
        ...
        .dark thead th {
            color: #94a3b8 !important; /* Readable slate-400 headers */
        ...
        .dark tr:hover {
            background-color: #334155 !important; /* Highlight slate-700 on hover */
        }
        .dark td.text-gray-300 {
            color: #475569 !important; /* Proper placeholder dash color */
        }
