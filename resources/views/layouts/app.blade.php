    ...
    <div x-data="{ sidebarOpen: localStorage.getItem('sidebarOpen') !== null ? localStorage.getItem('sidebarOpen') === 'true' : window.innerWidth >= 1024 }" x-init="$watch('sidebarOpen', val => localStorage.setItem('sidebarOpen', val))" class="flex h-screen overflow-hidden">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0 w-[280px] sm:w-64' : '-translate-x-full lg:translate-x-0 mini-sidebar'"
            ...
            <div class="flex-none">
                ...
                <div class="flex items-center justify-between px-4 sm:px-6 h-14 sm:h-16 bg-gradient-to-r from-blue-600 via-indigo-600 to-violet-700 text-white font-extrabold text-lg tracking-wider shadow-sm logo-container transition-all duration-300">
                    <div class="flex items-center">
                        <img src="{{ asset('logo.jpg') }}" alt="Logo" class="h-8 w-auto mr-2 sm:mr-3 rounded-lg ring-2 ring-white/20 transition-all duration-300 hover:rotate-6 sidebar-icon dark:bg-white dark:p-1">
                        <span class="logo-text transition-all duration-300 text-sm sm:text-base">KOMPASKARIR</span>
                    </div>
                    <button @click="sidebarOpen = false" class="text-white/80 hover:text-white focus:outline-none lg:hidden p-1.5 rounded-lg hover:bg-white/10 transition-colors" aria-label="Close Sidebar">
            ...
            <div class="flex-1 pb-3 sm:pb-4" :class="sidebarOpen ? 'overflow-y-auto overflow-x-hidden' : 'overflow-visible'">
                ...
                <nav class="px-2 sm:px-3 space-y-0.5 sm:space-y-1 sidebar-nav h-full">
                    ...
                    <div class="pt-3 sm:pt-4 pb-1.5 sm:pb-2 px-3 sm:px-4 text-[9px] sm:text-[10px] font-bold text-slate-400 uppercase tracking-widest sidebar-text transition-all duration-300">Eksplorasi Karir</div>
                    ...
                    <div class="pt-3 sm:pt-4 pb-1.5 sm:pb-2 px-3 sm:px-4 text-[9px] sm:text-[10px] font-bold text-slate-400 uppercase tracking-widest sidebar-text transition-all duration-300">Peluang & Pengembangan</div>
                    ...
                    <div class="pt-3 sm:pt-4 pb-1.5 sm:pb-2 px-3 sm:px-4 text-[9px] sm:text-[10px] font-bold text-slate-400 uppercase tracking-widest sidebar-text transition-all duration-300">Rekrutmen</div>
                    @can('post_jobs')
                    ...
                    <div class="pt-3 sm:pt-4 pb-1.5 sm:pb-2 px-3 sm:px-4 text-[9px] sm:text-[10px] font-bold text-slate-400 uppercase tracking-widest sidebar-text transition-all duration-300">Pembelajaran</div>
                    ...
                    <a href="{{ route('teacher.classes.index') }}"
                        ...
                        <span class="sidebar-text transition-all duration-300">Kelola Kelas</span>
                        <div class="menu-tooltip">Kelola Kelas</div>
                    </a>

                    <div class="pt-3 sm:pt-4 pb-1.5 sm:pb-2 px-3 sm:px-4 text-[9px] sm:text-[10px] font-bold text-slate-400 uppercase tracking-widest sidebar-text transition-all duration-300">Penilaian</div>
                    <a href="{{ route('teacher.submissions.index') }}"
                        ...
                        <span class="sidebar-text transition-all duration-300">Nilai Tugas</span>
                    ...
                    <div class="pt-3 sm:pt-4 pb-1.5 sm:pb-2 px-3 sm:px-4 text-[9px] sm:text-[10px] font-bold text-slate-400 uppercase tracking-widest sidebar-text transition-all duration-300">Manajemen Data</div>
                    ...
                    <div class="pt-3 sm:pt-4 pb-1.5 sm:pb-2 px-3 sm:px-4 text-[9px] sm:text-[10px] font-bold text-slate-400 uppercase tracking-widest sidebar-text transition-all duration-300">Manajemen Utama</div>
                    ...
                    <div class="pt-3 sm:pt-4 pb-1.5 sm:pb-2 px-3 sm:px-4 text-[9px] sm:text-[10px] font-bold text-slate-400 uppercase tracking-widest sidebar-text transition-all duration-300">Master Data</div>
                    ...
                    <div class="pt-3 sm:pt-4 pb-1.5 sm:pb-2 px-3 sm:px-4 text-[9px] sm:text-[10px] font-bold text-slate-400 uppercase tracking-widest sidebar-text transition-all duration-300">Sistem AI</div>
        ...
        <div class="flex-1 flex flex-col overflow-hidden min-w-0">
            <!-- Top Navbar -->
            <header class="flex items-center justify-between h-14 sm:h-16 px-3 sm:px-6 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-700/60 sticky top-0 z-40 shadow-md shadow-slate-200/50 dark:shadow-slate-900/50 transition-all duration-300 mb-4 sm:mb-6 lg:mb-8">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <button @click="sidebarOpen = !sidebarOpen" class="text-slate-500 focus:outline-none hover:text-slate-700 dark:text-slate-400 dark:hover:text-slate-200 p-2 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800 transition-all duration-200 active:scale-95 relative w-9 h-9 sm:w-10 sm:h-10 flex items-center justify-center lg:hidden" aria-label="Toggle Sidebar">
                        <div class="w-5 h-4 sm:w-6 sm:h-5 flex flex-col justify-between relative">
                            <span :class="sidebarOpen ? 'rotate-45 translate-y-[7px] sm:translate-y-[9px]' : ''" class="w-full h-[2px] bg-slate-600 dark:bg-slate-400 rounded-full transition-all duration-300 transform origin-center"></span>
                            <span :class="sidebarOpen ? 'opacity-0 translate-x-2' : ''" class="w-full h-[2px] bg-slate-600 dark:bg-slate-400 rounded-full transition-all duration-300 transform"></span>
                            <span :class="sidebarOpen ? '-rotate-45 -translate-y-[7px] sm:-translate-y-[9px]' : ''" class="w-full h-[2px] bg-slate-600 dark:bg-slate-400 rounded-full transition-all duration-300 transform origin-center"></span>
                        </div>
                    </button>
                ...
                <div class="flex items-center gap-1 sm:gap-3">
                    ...
                    <div class="relative" x-data="{ open: false }" x-cloak>
                        ...
                        <div x-show="open" @click.away="open = false" style="display: none;"
                            ...
                            x-transition:leave-start="opacity-100 scale-100 translate-y-0"
                            x-transition:leave-end="opacity-0 scale-95 translate-y-2"
                            class="absolute right-0 mt-3 w-72 sm:w-80 bg-white dark:bg-slate-800 rounded-2xl shadow-xl py-2 z-50 border border-slate-100 dark:border-slate-700/60 dark:shadow-slate-950/40">
            ...
            <!-- Page Content -->
            <main class="flex-1 overflow-x-hidden overflow-y-auto p-3 sm:p-4 md:p-6 relative">
