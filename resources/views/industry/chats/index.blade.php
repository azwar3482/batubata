<x-app-layout>
    <div class="py-6 h-[calc(100vh-64px)] overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col">
            ...
            <!-- Info Card -->
            <div class="mb-4 p-4 bg-gradient-to-r from-violet-50 to-purple-50 dark:from-violet-900/20 dark:to-purple-900/20 border border-violet-100 dark:border-violet-800/50 rounded-xl {{ $activeConversation ? 'hidden md:block' : '' }}">
