<x-app-layout>
    <div class="max-w-6xl mx-auto px-4 py-8">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 mb-6">
            ...
            <div class="px-5 py-4 border-t border-gray-100 dark:border-slate-800 bg-gray-50/50 dark:bg-slate-800/50 [&_p]:dark:text-slate-300 [&_span]:dark:text-slate-300 [&_a]:dark:text-slate-300 [&_svg]:dark:text-slate-400 [&_.bg-white]:dark:bg-slate-800 [&_.border-gray-300]:dark:border-slate-700 [&_.text-gray-700]:dark:text-slate-200 [&_.text-gray-500]:dark:text-slate-400">
