                    ...
                    <div class="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-800 relative z-20">
                        ...
                        <div class="p-6 space-y-5">
                            ...
                            <div>
                                ...
                                <textarea name="description" class="w-full border-gray-300 dark:border-slate-600 rounded-xl shadow-sm focus:ring-blue-500 focus:border-blue-500" rows="2"
                                    placeholder="Jelaskan instruksi khusus atau tujuan tes ini...">{{ old('description', $test->description) }}</textarea>
                            </div>
