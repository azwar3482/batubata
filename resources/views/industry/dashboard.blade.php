    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-8 flex items-center justify-between gap-4">
                <div>
                    <h2 class="text-3xl font-extrabold text-gray-900 dark:text-white">{{ __('messages.industry_dashboard') }}</h2>
                    <p class="mt-2 text-gray-600 dark:text-slate-400">
                        {{ __('messages.industry_desc') }}
                    </p>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div class="bg-white rounded-xl shadow-xl shadow-gray-200/50 dark:shadow-gray-900/50 p-6 border-l-4 border-blue-500 hover:shadow-lg transition cursor-pointer"
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium text-gray-500 uppercase tracking-wide">{{ __('messages.active_jobs') }}</p>
                ...
                <div class="bg-white rounded-xl shadow-xl shadow-gray-200/50 dark:shadow-gray-900/50 p-6 border-l-4 border-green-500 hover:shadow-lg transition">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium text-gray-500 uppercase tracking-wide">{{ __('messages.total_applicants') }}</p>
                            <p class="text-3xl font-bold text-gray-900 mt-2">{{ $stats['totalApplicants'] ?? 0 }}</p>
                            <p class="text-sm text-gray-500 mt-1">{{ __('messages.from_all_jobs') }}</p>
                        </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-sm text-purple-600 mt-1 flex items-center">
                                ...
                                {{ __('messages.quality_candidates') }}
                            </p>
                        </div>
                        <div
                ...
                <div class="bg-white rounded-xl shadow-xl shadow-gray-200/50 dark:shadow-gray-900/50 p-6 border-l-4 border-orange-500 hover:shadow-lg transition">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium text-gray-500 uppercase tracking-wide">{{ __('messages.recruitment_time') }}</p>
                            <p class="text-3xl font-bold text-gray-900 mt-2">{{ $stats['avgHiringDays'] ?? 14 }} {{ __('messages.days_avg') }}</p>
                            <p class="text-sm text-gray-500 mt-1">{{ __('messages.avg_post_to_hire') }}</p>
                        </div>
                        <div
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="bg-white rounded-xl shadow-xl shadow-gray-200/50 dark:shadow-gray-900/50 overflow-hidden">
                        <div
                            ...
                            <h3 class="text-lg font-bold text-gray-900">{{ __('messages.latest_jobs') }}</h3>
                            <div class="flex flex-col sm:flex-row sm:items-center gap-3">
                                <div class="relative">
                                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                     ...
                                     <input type="text" id="searchTable" placeholder="{{ __('messages.search_jobs') }}" class="pl-9 pr-4 py-1.5 border-gray-300 bg-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full transition">
                                </div>
                                <div class="flex gap-2 items-center">
                                    <a href="{{ route('industry.jobs.create') }}"
                                     ...
                                     <a href="{{ route('industry.jobs.index') }}" class="text-sm text-gray-600 hover:text-gray-800 whitespace-nowrap">{{ __('messages.view_all') }}</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tr>
                                        <th
                                         ...
                                         <th
                                             ...
                                             {{ __('messages.position') }}</th>
                                         <th
                                             class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                             {{ __('messages.location') }}</th>
                                         <th
                                             class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                             {{ __('messages.applicants') }}</th>
                                         <th
                                             class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr class="hover:bg-gray-50 transition job-row">
                                        ...
                                        <td class="px-6 py-4 text-right">
                                            <div class="flex items-center justify-end gap-3">
                                                <a href="{{ route('industry.jobs.show', $job->id) }}" class="text-blue-600 hover:text-blue-900" title="{{ __('messages.view_detail') }}">
                                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path>
                                                    </svg>
                                                </a>
                                                <a href="{{ route('industry.jobs.edit', $job->id) }}" class="text-yellow-600 hover:text-yellow-900" title="{{ __('messages.edit_job') }}">
                                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <tr id="emptySearchRow" style="display: none;">
                                                 <td colspan="6" class="px-6 py-12 text-center text-gray-500 text-sm">{{ __('messages.not_found') }}</td>
                                             </tr>
                                             <tr class="empty-state">
                                                 <td colspan="6" class="px-6 py-12 text-center">
                                                     ...
                                                     <p class="mt-2 text-gray-500">{{ __('messages.no_active_jobs') }}</p>
                                                     <a href="{{ route('industry.jobs.create') }}"
                                                         class="mt-4 inline-block text-blue-600 hover:text-blue-800 font-medium">{{ __('messages.post_first_job') }}</a>
                                        </td>
                                    </tr>
                                    @endforelse
                                </tbody>
                    ...
                    <div class="bg-white dark:bg-slate-900 rounded-xl shadow-xl shadow-gray-200/50 dark:shadow-gray-900/50 p-6 border border-transparent dark:border-slate-800">
                        <div class="flex items-center justify-between mb-4">
                            <h3 class="text-lg font-bold text-gray-900 dark:text-white">{{ __('messages.recruitment_analytics') }}</h3>
                            <select
                                class="text-sm border-gray-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-gray-700 dark:text-slate-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                 ...
                                 <option>{{ __('messages.last_90_days') }}</option>
                        ...
                        <div class="mt-4 grid grid-cols-3 gap-4 text-center">
                            <div>
                                <p class="text-2xl font-bold text-blue-600 dark:text-blue-400">{{ $funnelPercentages['applied'] ?? 0 }}%</p>
                                 <p class="text-xs text-gray-500 dark:text-slate-400">{{ __('messages.resume_screened') }}</p>
                             </div>
                             <div>
                                 <p class="text-2xl font-bold text-purple-600 dark:text-purple-400">{{ $funnelPercentages['interview'] ?? 0 }}%</p>
                                 <p class="text-xs text-gray-500 dark:text-slate-400">{{ __('messages.interview_completed') }}</p>
                             </div>
                             <div>
                                 <p class="text-2xl font-bold text-green-600 dark:text-green-400">{{ $funnelPercentages['accepted'] ?? 0 }}%</p>
                                 <p class="text-xs text-gray-500 dark:text-slate-400">{{ __('messages.offer_accepted') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-8">
                    ...
                    <div class="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-xl shadow-lg p-6 text-white">
                         <h3 class="text-lg font-bold mb-4">⚡ {{ __('messages.quick_actions') }}</h3>
                        <div class="space-y-3">
                            <a href="{{ route('industry.jobs.create') }}"
                                ...
                                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                 ...
                                 <span class="text-sm font-medium">{{ __('messages.post_new_job') }}</span>
                            </a>
                            <a href="{{ route('industry.candidates') }}"
                                class="flex items-center p-3 bg-white/10 rounded-lg hover:bg-white/20 transition">
                                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                 ...
                                 <span class="text-sm font-medium">{{ __('messages.search_candidates') }}</span>
                            </a>
                            <a href="{{ route('industry.dashboard.report') }}"
                                ...
                                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                 ...
                                 <span class="text-sm font-medium">{{ __('messages.download_report') }}</span>
                            </a>
                            <a href="{{ route('industry.team') }}"
                                ...
                                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                 ...
                                 <span class="text-sm font-medium">{{ __('messages.team_management') }}</span>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="bg-white dark:bg-slate-900 rounded-xl shadow-xl shadow-gray-200/50 dark:shadow-gray-900/50 overflow-hidden border border-slate-100 dark:border-slate-800">
                        <div class="p-6 border-b border-gray-200 dark:border-slate-700">
                             <h3 class="text-lg font-bold text-gray-900 dark:text-white">{{ __('messages.high_match_candidates') }}</h3>
                             <p class="text-xs text-gray-500 dark:text-slate-400 mt-1">{{ __('messages.based_on_active_jobs') }}</p>
                        </div>
                        <div class="divide-y divide-gray-200 dark:divide-slate-700">
                            ...
                            <div class="p-4 hover:bg-gray-50 dark:hover:bg-slate-800 transition">
                             ...
                             <div class="p-8 text-center">
                                 <p class="text-sm text-gray-500 dark:text-slate-400">{{ __('messages.no_candidates_yet') }}</p>
                            </div>
                            @endforelse
                        </div>
                        <div class="p-4 border-t border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-slate-800 text-center">
                            <a href="{{ route('industry.candidates') }}"
                                class="text-sm text-blue-600 hover:text-blue-800 font-medium">
                                 {{ __('messages.view_all_candidates') }} →
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-xl shadow-gray-200/50 dark:shadow-gray-900/50 p-6">
                         <h3 class="text-lg font-bold text-gray-900 mb-4">{{ __('messages.company_profile') }}</h3>
                        ...
                        <div class="space-y-2 text-sm">
                            <div class="flex justify-between">
                                 <span class="text-gray-500">{{ __('messages.company_size') }}</span>
                                 <span class="font-medium">{{ Auth::user()->company->size ?? '-' }}</span>
                             </div>
                             <div class="flex justify-between">
                                 <span class="text-gray-500">{{ __('messages.website') }}</span>
                                 <a href="{{ Auth::user()->company->website ?? '#' }}" target="_blank"
                                     class="font-medium text-blue-600 hover:underline">
                                     {{ Auth::user()->company->website ? parse_url(Auth::user()->company->website, PHP_URL_HOST) : __('messages.not_set') }}
                                 </a>
                             </div>
                             <div class="flex justify-between">
                                 <span class="text-gray-500">{{ __('messages.active_jobs') }}</span>
                        ...
                        <a href="{{ route('profile.edit') }}"
                            class="mt-4 block w-full text-center px-4 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 transition">
                             {{ __('messages.edit_company_profile') }}
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200 rounded-xl p-6 mb-8">
                <div class="flex flex-col md:flex-row md:items-center gap-4">
                    ...
                    <div class="flex-1">
                         <h4 class="font-semibold text-amber-900 dark:text-amber-300">💡 {{ __('messages.tips_effective_job_posting') }}</h4>
                         <p class="text-sm text-amber-800 dark:text-amber-400/80 mt-1">
                             {{ __('messages.tips_desc') }}
                        </p>
                    </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const chart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                        label: '{{ __("messages.new_applicants") }}',
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        const tourSteps = [
            {
                    popover: {
                        title: '{{ __("messages.welcome") }} {{ __("messages.industry_role") }}',
            ...
            },
            {
                element: 'a[href*="industry/dashboard"]',
                    popover: {
                        title: '{{ __("messages.industry_dashboard") }}',
                        description: '{{ __("messages.industry_desc") }}',
                    side: "right",
                    align: 'start'
                }
            },
            {
                element: 'a[href*="industry/jobs"]',
                    popover: {
                        ...
                        description: '{{ __("messages.about_jobs_desc") }}',
                    side: "right",
                    align: 'start'
                }
            },
            {
                element: 'a[href*="industry/candidates"]',
                    popover: {
                        title: '{{ __("messages.find_candidates") }}',
                        description: '{{ __("messages.candidate_search_desc") }}',
                    side: "right",
                    align: 'start'
                }
            },
            {
                element: 'a[href*="industry/tpa"]',
                    popover: {
                        title: '{{ __("messages.tpa_management") }}',
                        description: '{{ __("messages.tpa_management_desc") }}',
                    side: "right",
                    align: 'start'
                }
            },
            {
                element: 'a[href*="industry/tpa/questions"]',
                    popover: {
                        title: '{{ __("messages.tpa_questions") }}',
            ...
            },
            {
                element: 'a[href*="industry/competencies"]',
                    popover: {
                        title: '{{ __("messages.manage_competencies") }}',
                        description: '{{ __("messages.manage_competencies") }}',
                    side: "right",
                    align: 'start'
                }
            },
            {
                element: 'a[href*="industry/team"]',
                    popover: {
                        title: '{{ __("messages.team_management") }}',
                        description: '{{ __("messages.team_desc") }}',
                    side: "right",
                    align: 'start'
                }
            },
