...
<head>
    <meta charset="utf-8">
    <title>Sertifikat Kelulusan - {{ $enrollment->user->name }}</title>
    <style>
        @page {
            size: A4 landscape;
            margin: 0;
...
<body>
    <div class="container">
        <div class="inner">
            ...
            <div class="presented-to">Sertifikat ini dengan bangga diberikan kepada:</div>
            ...
            <div class="course-title">{{ $enrollment->classRoom->course->title }}</div>
            ...
            <table class="signatures-table">
                <tr>
                    ...
                    <td>
                        <div class="sig-name">{{ $enrollment->classRoom->teacher->name }}</div>
                        <div class="sig-line"></div>
                        <div class="sig-label">{{ $enrollment->classRoom->teacher->name }}</div>
                        <div class="sig-sublabel">Pengajar / Instruktur</div>
                    </td>
                    <td>
                    ...
                    <td>
                        <div class="sig-name">Tim Batubata</div>
                        <div class="sig-line"></div>
                        <div class="sig-label">Tim Akademik</div>
                        <div class="sig-sublabel">Batubata Learning Platform</div>
                    </td>
                </tr>
            </table>
            ...
            <table class="footer-table">
                <tr>
                    <td align="left" style="vertical-align: bottom;">Tanggal Kelulusan: {{ $enrollment->completed_at ? $enrollment->completed_at->format('d M Y') : '-' }}</td>
                        ...
                        <table style="border: none; margin-left: auto; width: auto; border-collapse: collapse;">
                            <tr>
                                <td align="right" style="font-family: sans-serif; font-size: 9px; line-height: 1.2; color: #4b5563; padding-right: 8px; border: none; vertical-align: middle; width: auto;">
                                    ...
                                    <div style="font-family: monospace; font-size: 9px; color: #9ca3af; margin-top: 2px;">ID: {{ $enrollment->certificate_code }}</div>
                                </td>
                                <td style="border: none; vertical-align: middle; width: 48px; padding: 0;">
                                    <div style="border: 1px solid #d4af37; background-color: #ffffff; padding: 2px; width: 44px; height: 44px;">
                                        <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data={{ urlencode($enrollment->certificate_code) }}" style="width: 44px; height: 44px;">
                                    </div>
                                </td>
                            </tr>
                        </table>
