            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div class="lg:col-span-8 space-y-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
                        <div class="p-8">
                            <div class="flex flex-col md:flex-row md:items-start justify-between gap-6">
                                <div class="flex items-start gap-5">
                                    ...
                                    <div class="w-20 h-20 bg-gradient-to-br from-blue-50 dark:from-blue-900/30 to-indigo-50 dark:to-indigo-900/30 rounded-2xl flex items-center justify-center text-blue-600 dark:text-blue-400 font-bold text-2xl border border-blue-100 dark:border-blue-800 shadow-inner flex-shrink-0">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-lg text-blue-600 dark:text-blue-400 font-medium flex items-center gap-1.5 mb-4">
                                            {{ $job->company_name }}
                                        ...
                                        <div class="flex flex-wrap items-center gap-3 text-sm">
                                            <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-600">
                        ...
                        <div class="bg-gray-50/80 dark:bg-gray-800/80 border-t border-gray-100 dark:border-gray-700 px-8 py-4 flex flex-col sm:flex-row items-center justify-between gap-4">
                            @if ($job->salary_min)
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-8">
                        ...
                        <!-- Progress Bar -->
                        <div class="w-full bg-gray-100 dark:bg-gray-700 rounded-full h-2.5 mb-8 overflow-hidden">
                                ...
                                <div class="grid sm:grid-cols-2 gap-3">
                                    ...
                                    <div class="flex items-center justify-between p-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl hover:border-blue-300 dark:hover:border-blue-500 hover:shadow-md transition-all group">
                                        <div class="flex items-center gap-3">
                                            <div class="w-8 h-8 rounded-lg bg-red-50 dark:bg-red-900/30 flex items-center justify-center text-red-500 group-hover:bg-red-100 dark:group-hover:bg-red-900/50 transition-colors">
                            ...
                            @else
                                ...
                                @else
                                    ...
                                    <form action="{{ route('seeker.jobs.apply', $job->id) }}" method="POST" class="space-y-5" x-data @submit.prevent="if({{ $job->matching_percentage ?? 0 }} < 75) { $dispatch('open-low-match-modal'); } else { $el.submit(); }">
                                        ...
                                        <div class="p-4 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl group relative overflow-hidden">
                                            <div class="flex items-start gap-3 relative z-10">
                                                <div class="w-10 h-10 rounded-lg bg-white dark:bg-gray-800 shadow-sm flex items-center justify-center border border-gray-100 dark:border-gray-700 shrink-0">
    ...
    <div x-data="{ open: false }" 
        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div x-show="open" 
                 ...
                 class="inline-block align-bottom bg-white dark:bg-gray-800 rounded-2xl px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6 border border-gray-100 dark:border-gray-700">
