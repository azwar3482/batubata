    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex justify-between items-center mb-6">
                <div>
                    <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Skill Keyword</h2>
                    <p class="text-xs text-gray-500 dark:text-slate-400 mt-1">Perbarui skill keyword untuk dibaca oleh modul AI.</p>
                </div>
