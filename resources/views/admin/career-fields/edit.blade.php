            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white dark:bg-slate-900 shadow-sm rounded-2xl p-6 border border-gray-100 dark:border-slate-800">
                    ...
                    <div class="mt-6">
                        ...
                        <trix-editor input="description" class="trix-content bg-white dark:bg-slate-800 border border-gray-300 dark:border-slate-750 rounded-lg text-sm text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors" placeholder="Jelaskan tentang bidang karir ini..."></trix-editor>
