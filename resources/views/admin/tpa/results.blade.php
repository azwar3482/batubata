        ...
        <table class="w-full">
            ...
            <tbody class="divide-y">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-4 py-3 text-center text-sm">{{ $r->verbal_score }}%</td>
                    <td class="px-4 py-3 text-center text-sm">{{ $r->numerik_score }}%</td>
                    <td class="px-4 py-3 text-center text-sm">{{ $r->logika_score }}%</td>
                    <td class="px-4 py-3 text-center text-sm">{{ $r->spasial_score }}%</td>
                    <td class="px-4 py-3 text-center font-bold">{{ $r->total_score }}%</td>
                    <td class="px-4 py-3 text-center">{{ $r->bappenas_score }}</td>
                    ...
                    <td class="px-4 py-3 text-center">
                        <div class="flex items-center justify-center gap-2">
                            <a href="{{ route('admin.tpa.results.show', $r) }}" class="text-blue-600 hover:underline text-sm">Detail</a>
                            <a href="{{ route('admin.tpa.results.pdf', $r) }}" class="text-red-600 hover:underline text-sm">PDF</a>
                        </div>
                    </td>
                </tr>
                @endforeach
