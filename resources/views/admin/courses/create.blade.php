...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="flex justify-between items-center mb-6 anim-1">
            <div>
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Tambah Kursus Baru</h2>
                <p class="text-xs text-gray-500 dark:text-slate-400 mt-1">Buat data kursus baru untuk rekomendasi kompetensi.</p>
            </div>
