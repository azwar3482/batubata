        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-8 flex items-center justify-between">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h2 class="text-3xl font-extrabold text-gray-900 leading-tight">Edit Jabatan</h2>
                        <p class="mt-1 text-sm text-gray-500">Ubah detail jabatan yang sudah terdaftar di sistem.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
                <form action="{{ route('admin.positions.update', $position) }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" required value="{{ $position->name }}" 
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="4" 
                                  class="w-full border-gray-200 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition px-4 py-3 bg-gray-50/50">{{ $position->description }}</textarea>
                    </div>
