    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="flex justify-between items-center mb-6 anim-1">
            <div>
                ...
                <p class="text-xs text-gray-500 dark:text-slate-400 mt-1">Ubah detail jabatan {{ $position->name }}.</p>
            </div>
        ...
        <div class="bg-white dark:bg-slate-800 overflow-hidden shadow-sm sm:rounded-2xl border border-gray-100 dark:border-slate-700 anim-2">
            ...
            <form action="{{ route('admin.positions.update', $position) }}" method="POST" class="space-y-6" id="positionForm">
            @csrf @method('PUT')
            <div class="space-y-5">
                <div>
                ...
                <div class="relative" x-data="searchableDropdown({
                    ...
                    selected: '{{ old('category', $position->category) }}',
                ...
                <div>
                    ...
                    <input type="hidden" name="description" id="description" value="{{ $position->description }}">
