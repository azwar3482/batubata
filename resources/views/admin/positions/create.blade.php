...
<div class="max-w-4xl mx-auto px-4 sm:px-6 py-1">
    ...
    <div class="mb-6 anim-1">
        <h1 class="text-2xl font-extrabold text-gray-900 dark:text-white">Buat Jabatan Baru</h1>
        ...
        <form action="{{ route('admin.positions.store') }}" method="POST" class="p-6 sm:p-8 space-y-6">
            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="4" placeholder="Jelaskan tanggung jawab jabatan ini..." class="w-full px-4 py-2.5 border border-gray-200 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm transition"></textarea>
                </div>
            </div>
