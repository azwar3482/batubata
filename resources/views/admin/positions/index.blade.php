<x-app-layout>
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <!-- Info Card -->
            <div class="mb-6 p-5 bg-gradient-to-r from-purple-50 to-fuchsia-50 dark:from-purple-900/20 dark:to-fuchsia-900/20 border border-purple-100 dark:border-purple-800/50 rounded-xl">
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        <h4 class="text-sm font-bold text-purple-900 dark:text-purple-200 mb-1">Tentang Master Jabatan</h4>
                        <p class="text-sm text-purple-700 dark:text-purple-300 leading-relaxed">Posisi/Jabatan adalah target karir yang diinginkan job seeker. Setiap posisi memiliki <strong>daftar kompetensi</strong> yang dibutuhkan. Saat job seeker mengambil asesmen, sistem akan mengukur <strong>skill gap</strong> berdasarkan kompetensi yang terkait dengan posisi ini.</p>
                    </div>
                </div>
            </div>
