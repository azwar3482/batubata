    ...
    <div class="py-8">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                ...
                <h2 class="text-3xl font-extrabold text-gray-900">Tambah Kompetensi Baru</h2>
                <p class="mt-2 text-gray-600">Buat data kompetensi baru yang dapat digunakan pada lowongan dan penilaian.</p>
            </div>

            <div class="bg-white rounded-xl shadow-md overflow-hidden">
                <form action="{{ route('admin.competencies.store') }}" method="POST" class="p-8 space-y-6">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-1">
                            ...
                            <input type="number" name="min_level_required" id="min_level_required" required min="1" max="5" value="{{ old('min_level_required') }}"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
                                placeholder="Cth: 3">
                        ...
                        <div class="md:col-span-1">
                            ...
                            <input type="text" name="source_reference" id="source_reference" value="{{ old('source_reference') }}"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
