        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 p-5 bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border border-amber-100 dark:border-amber-800/50 rounded-xl">
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        <h4 class="text-sm font-bold text-amber-900 dark:text-amber-200 mb-1">Tentang Master Kategori</h4>
                        <p class="text-sm text-amber-700 dark:text-amber-300 leading-relaxed">Kategori digunakan untuk mengelompokan data dalam sistem. Ada 3 jenis kategori: <strong>Kompetensi</strong> (Teknis/Soft Skill), <strong>Industri</strong> (bidang perusahaan), dan <strong>Posisi</strong> (jabatan kerja). Kategori membantu sistem dalam <strong>filtering</strong> dan <strong>rekomendasi</strong> yang lebih akurat.</p>
                    </div>
                </div>
            </div>
