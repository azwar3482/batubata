...
<div class="max-w-4xl mx-auto px-4 sm:px-6 py-1">
    ...
    <div class="mb-6 anim-1">
        <h1 class="text-2xl font-extrabold text-gray-900 dark:text-white">Edit Kategori</h1>
        <p class="text-gray-500 dark:text-gray-400 mt-1">Ubah data kategori master untuk sistem Anda.</p>
    </div>
